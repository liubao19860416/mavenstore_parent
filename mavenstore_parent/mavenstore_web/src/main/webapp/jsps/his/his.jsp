...
<script type="text/javascript">
	...
	$("#selectedPageNum1").click(function(event){
		...
		//判断页码范围
		var totalPageCount=new Number();
		totalPageCount= $("#totalPageCount").val();
		totalPageCount=new Number(totalPageCount);
		...
		<tr valign="top">
			<td rowspan="2">
				<form action="" name="select">
					...
					<L:pageTag paramUrl="${page.paramUrl}" totalCount="${page.totalCount}" numberPerPage="${page.numberPerPage}" pageNum="${page.pageNum}"></L:pageTag>
