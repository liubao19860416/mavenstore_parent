...
<body>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr valign="top">
			...
			<s:form name="select" method="post" action="storeAction_updateStore">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tx" align="center">
						...
						<tr>
							...
							<td>
							<s:fielderror fieldName="name.required"></s:fielderror>
							<s:textfield cssClass="tx" name="name" value="%{name}"></s:textfield>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
							<s:fielderror fieldName="addr.required"></s:fielderror>
							<s:textfield cssClass="tx" name="addr" value="%{addr}"></s:textfield>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
							<s:fielderror fieldName="manager.required"></s:fielderror>
						...
						<tr>
							<td colspan="2" align="center" style="padding-top:10px;">
								...
								<input class="tx" style="width:120px;margin-right:30px;" type="button" id="cancelbutton" value="取消">
							</td>
						</tr>
					</table>
				</s:form>
